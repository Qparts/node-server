...
const NOTIFICATION_CUSTOMER = 'notifications/customer';
const QUOTATION = 'quotation';
const Q_WIRE_TRANSFER = 'wire-transfer';
const Q_CREDIT_CARD = 'credit-card';
const Q_PAYMENT_3DSECURE_RESPONSE = 'payment';
...
const POST_QUOTATIONS_WIRE_TRANSFER_URL = `${QUOTATION_SERVICE}/${API_V2}/${QUOTATION}/wire-transfer`;
const POST_QUOTATIONS_CC_URL = `${QUOTATION_SERVICE}/${API_V2}/${QUOTATION}/credit-card`;
const PUT_QUOTATION_READ_URL = `${QUOTATION_SERVICE}/${API_V2}/${QUOTATION_READ}`;
const PUT_QUOTATION_PAYMENT_URL = `${QUOTATION_SERVICE}/${API_V2}/quotation/${Q_PAYMENT_3DSECURE_RESPONSE}`;

const CUSTOMER_NOTIFICATION_WS = `${WS_BASE_URL}/${QUOTATION_SERVICE}/${WS}/${NOTIFICATION_CUSTOMER}`;
const CUSTOMER_PUSH_NOTIFICATION_WS = `${WS_BASE_URL}/${CUSTOMER_SERVICE}/${WS}/${NOTIFICATION_CUSTOMER}`;
